...
export const INITIAL_POSITIONS = [
  { id: 'pos_0', companyId: MOCK_COMPANY_ID, name: 'Manager', color: '#7c3aed' }, // Violet
  { id: 'pos_1', companyId: MOCK_COMPANY_ID, name: 'Chef', color: '#ef4444' }, // Red
  { id: 'pos_2', companyId: MOCK_COMPANY_ID, name: 'Waiter', color: '#3b82f6' }, // Blue
  { id: 'pos_3', companyId: MOCK_COMPANY_ID, name: 'Barista', color: '#f59e0b' }, // Amber
  { id: 'pos_4', companyId: MOCK_COMPANY_ID, name: 'Cleaner', color: '#10b981' }, // Emerald
];
